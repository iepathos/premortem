...
- Refreshed `Cargo.lock` with latest compatible transitive dependency updates
...
- Fixed deprecated `criterion::black_box` usage in benchmarks
- Fixed deprecated `ImDocument` usage in TOML source parsing

### Changed

- Updated `toml` dependency from 0.8.23 to 0.9.8
- Updated `toml_edit` dependency from 0.22.27 to 0.23.9
- Updated `criterion` dev-dependency from 0.5.1 to 0.8.1
...
[Unreleased]: https://github.com/iepathos/premortem/compare/v0.6.3...HEAD
[0.6.3]: https://github.com/iepathos/premortem/compare/v0.6.2...v0.6.3
